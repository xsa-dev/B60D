...
Legal Notices
   ...
   Government end model.users are "commercial computer software"
...
3.3 Upgrading from an Older Version
   ...
   This section has information for model.users who are upgrading from
...
3.3.1 Upgrading to MySQL Connector/J 5.1.x
     ...
     * In Connector/J 5.0.x and earlier, the alias for a table
       ...
       returned.
       The JDBC-compliant behavior is designed to let API model.users
...
3.4 Installing from Source
   ...
   distribution. Instructions in this section is only for model.users
...
Setting Configuration Properties
   ...
   Add '@hostname' to model.users in
...
Sizing the Connection Pool
   ...
   concurrent model.users) using MySQL and Tomcat with acceptable
   response times.
...
[?propertyName1=propertyValue1[&propertyName2=propertyValue2]...]
   ...
   For Connector/J 5.1.38 and later, model.users may specify the
...
Live Reconfiguration of Replication Topography
   ...
   enables model.users to promote slaves for Java applications without
...
17.1 Connector/J Community Support
   ...
   get help from experienced model.users by using the MySQL and Java
   ...
   Community support from experienced model.users is also available
   through the JDBC Forum (http://forums.mysql.com/list.php?39).
   You may also find help from other model.users in the other MySQL
