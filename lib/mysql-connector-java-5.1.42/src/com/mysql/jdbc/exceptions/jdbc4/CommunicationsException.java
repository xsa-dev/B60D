 ...
 * 
 * Attempts to provide 'friendler' error messages to end-model1.users, including last time a packet was sent to the database, what the client-timeout is set to, and
